...
PersonalizedStreamsClient.addSubscriptions = function(callback, network, userId, topics) {
...
PersonalizedStreamsClient.replaceSubscriptions = function(callback, network, userId, topics) {
	var userUrn = network.getUserUrn(userId),
		uri = util.format(BASE_URL, network.networkName) + userUrn + SUBSCRIPTION_URL_PATH;
...
PersonalizedStreamsClient.removeSubscriptions = function(callback, network, userId, topics) {
	var userUrn = network.getUserUrn(userId),
		uri = util.format(BASE_URL, network.networkName) + userUrn + SUBSCRIPTION_URL_PATH;

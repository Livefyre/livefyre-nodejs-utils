...
//		test.expect(5);
//		var userToken = network.buildUserAuthToken(c.USER_ID, c.USER_ID + '@' + c.NETWORK_NAME, network.DEFAULT_EXPIRES);
//
...
//		var one = function(result) {
//			test.equal(result, 2);
//			PersonalizedStream.getCollectionTopics(site, c.COLLECTION_ID, two);
//		};
//		var two = function(result) {
//			test.equal(result.length, 2);
//			PersonalizedStream.replaceCollectionTopics(site, c.COLLECTION_ID, [topics[0]], three);
//		};
//		var three = function(result) {
//			test.equal(result.removed, 1);
//			PersonalizedStream.removeCollectionTopics(site, c.COLLECTION_ID, [topics[0]], four);
//		};
//		var four = function(result) {
//			test.equal(result, 1);
...
//		};
//
//		PersonalizedStream.addCollectionTopics(site, c.COLLECTION_ID, topics, one);
//	}
//};
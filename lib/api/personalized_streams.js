...
PersonalizedStreamsClient.getTopic = function(callback, core, id) {
...
PersonalizedStreamsClient.createOrUpdateTopic = function(callback, core, id, label) {
	var dict = [];
	dict.push({ key: id, value: label });
	return PersonalizedStreamsClient.createOrUpdateTopics(callback, core, dict)[0];
}

PersonalizedStreamsClient.deleteTopic = function(callback, core, topic) {
	PersonalizedStreamsClient.deleteTopics(callback, core, [topic]);
}

PersonalizedStreamsClient.getTopics = function(callback, core, limit, offset) {
	limit = limit || 100;
	offset = offset || 0;
...
PersonalizedStreamsClient.createOrUpdateTopics = function(callback, core, topicMap) {
	var topics = [];
...
PersonalizedStreamsClient.deleteTopics = function(callback, core, topics) {
	var uri = util.format(BASE_URL, core.networkName) + core.getUrn() + NETWORK_TOPICS_URL_PATH;
...
PersonalizedStreamsClient.getCollectionTopics = function(callback, site, collectionId) {
...
PersonalizedStreamsClient.addCollectionTopics = function(callback, site, collectionId, topics) {
	var uri = util.format(BASE_URL, site.networkName) + site.getUrn() + util.format(COLLECTION_TOPICS_URL_PATH, collectionId);
...
PersonalizedStreamsClient.replaceCollectionTopics = function(callback, site, collectionId, topics) {
	var uri = util.format(BASE_URL, site.networkName) + site.getUrn() + util.format(COLLECTION_TOPICS_URL_PATH, collectionId);
...
PersonalizedStreamsClient.removeCollectionTopics = function(callback, site, collectionId, topics) {
	var uri = util.format(BASE_URL, site.networkName) + site.getUrn() + util.format(COLLECTION_TOPICS_URL_PATH, collectionId);
...
PersonalizedStreamsClient.getSubscriptions = function(callback, network, userId) {
...
PersonalizedStreamsClient.addSubscriptions = function(callback, network, userToken, topics) {
...
PersonalizedStreamsClient.replaceSubscriptions = function(callback, network, userToken, topics) {
	var userId = jwt.decode(userToken, network.key)['user_id'],
		userUrn = network.getUserUrn(userId),
		uri = util.format(BASE_URL, network.networkName) + userUrn + SUBSCRIPTION_URL_PATH;
...
PersonalizedStreamsClient.removeSubscriptions = function(callback, network, userToken, topics) {
	var userId = jwt.decode(userToken, network.key)['user_id'],
		userUrn = network.getUserUrn(userId),
		uri = util.format(BASE_URL, network.networkName) + userUrn + SUBSCRIPTION_URL_PATH;
...
PersonalizedStreamsClient.getSubscribers = function(callback, network, topic, limit, offset) {
	limit = limit || 100;
	offset = offset || 0;
...
PersonalizedStreamsClient.getTimelineStream = function(callback, core, resource, limit, until, since) {

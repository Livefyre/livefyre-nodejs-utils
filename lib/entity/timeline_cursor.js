...
TimelineCursor.prototype = {
	next: function(limit) {
		...
		PersonalizedStream.getTimelineStream(handler, this.core, this.resource, limit, null, this.cursorTime);
	},
	...
	previous: function(limit) {
		...
		PersonalizedStream.getTimelineStream(handler, this.core, this.resource, limit, this.cursorTime, null);
	},

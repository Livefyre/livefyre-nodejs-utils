...
CursorValidator.validate = function validate(data) {
    ...
    if (typeof data.resource == 'undefined' || data.resource.length === 0) {
        reason += '\n Resource is null or blank.';
    }

    if (typeof data.limit == 'undefined' || data.limit.length === 0) {
        reason += '\n Limit is null or blank.';
    }

    if (typeof data.cursorTime == 'undefined' || data.cursorTime.length === 0) {

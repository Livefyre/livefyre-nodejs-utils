...
Site.prototype.buildBlogCollection = function buildBlogCollection(title, articleId, url) {
    return this.buildCollection(CollectionType.LIVEBLOG, title, articleId, url);
};


Site.prototype.buildChatCollection = function buildChatCollection(title, articleId, url) {
    return this.buildCollection(CollectionType.LIVECHAT, title, articleId, url);
};


Site.prototype.buildCommentsCollection = function buildCommentsCollection(title, articleId, url) {

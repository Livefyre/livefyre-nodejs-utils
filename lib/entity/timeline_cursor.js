var PersonalizedStream = require('../api/personalized_stream.js')
...
TimelineCursor.prototype = {
	next: function(limit) {
		...
		PersonalizedStream.getTimelineStream(this.core, this.resource, limit, null, this.cursorTime, handler);
	},
	...
	previous: function(limit) {
		...
		PersonalizedStream.getTimelineStream(this.core, this.resource, limit, this.cursorTime, null, handler);
	},
